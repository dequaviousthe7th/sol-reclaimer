...
export default function HackathonPage() {
  return (
    <main className="flex-1 flex flex-col xl:min-h-0">
      ...
      {/* Page header */}
      <header className="pt-4 px-4 mb-2 mx-auto w-full max-w-5xl">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop: inline link. Mobile: below header */}
          <a
            href="https://hackathon.pump.fun/"
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#111113] border border-[#222228] text-xs text-gray-400 hover:text-solana-purple hover:border-solana-purple/30 transition-colors"
          >
        ...
        {/* Mobile: hackathon link below title */}
        <div className="sm:hidden mt-2">
          <a
            href="https://hackathon.pump.fun/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#111113] border border-[#222228] text-xs text-gray-400 hover:text-solana-purple hover:border-solana-purple/30 transition-colors"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
            </svg>
      ...
      <div className="flex-1 overflow-y-auto scroll-fade px-4 pb-4 xl:pb-2">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Mobile side panel cards — below screener */}
          <div className="xl:hidden mt-4 space-y-4">
            <HackathonDetails mobile />
